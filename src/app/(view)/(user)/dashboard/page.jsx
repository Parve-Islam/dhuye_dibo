...
export default function Dashboard() {
  ...
  const getReminderStatusClass = (reminder) => {
    ...
    if (reminder.isCompleted) {
      return "bg-red-100 border-gray-300"; // Completed reminders
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="border-4 border-dashed border-gray-200 rounded-lg p-6 bg-white mb-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link 
                href="/reminder" 
                className="px-4 py-2 bg-yellow-600 text-white rounded hover:bg-blue-700 transition-colors text-sm"
              >
                View All Reminders
              </Link>
            </div>
          ...
          <div className="border-4 border-dashed border-green-200 rounded-lg p-6 bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p><span className="text-center">hello: </span></p>
              </div>
            </div>
